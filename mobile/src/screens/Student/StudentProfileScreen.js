...
export default function StudentProfileScreen() {
  ...
  const { isCompletedOjt } = useTraineeStore();
    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.menu}>
          ...
          {isCompletedOjt && (
            <MenuItem
              icon={<Ionicons name="checkmark-done-outline" size={20} color="#0057ff" />}
          ...
          {/* AI Assistant */}
          <MenuItem
            icon={<Ionicons name="chatbubble-ellipses-outline" size={20} color="#0057ff" />}
            label="AI Assistant"
            onPress={() => navigation.navigate("AIAssistant")}
          />
          {/* Email Verification */}
          <MenuItem
            icon={<Ionicons name="mail-outline" size={20} color="#0057ff" />}
