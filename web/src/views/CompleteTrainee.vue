      ...
      <div class="p-6 border-b bg-gradient-to-r from-gray-50 to-white">
        <div class="flex justify-between items-center gap-4">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h3 class="text-lg font-bold text-gray-800">Completed Trainee List</h3>
...
const trainees = computed(() => traineeStore.completedOjtTrainees);
...
const viewTrainee = (trainee) => {
  router.push({ name: "CompletedTraineeDetails", params: { id: trainee.trainee_id } });
};
...
const fetchData = async (page = 1) => {
  await traineeStore.getCompletedOjtTrainees({ page, search: searchQuery.value.trim() });
};
