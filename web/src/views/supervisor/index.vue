    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
      ...
      <div class="p-6 border-b bg-gradient-to-r from-gray-50 to-white">
        <div class="flex justify-between items-center gap-4">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h3 class="text-lg font-bold text-gray-800">Supervisor List</h3>
              <p class="text-xs text-gray-500">
                Showing {{ supervisors.length }} of {{ pagination.total }} Supervisors
              </p>
            </div>
          </div>
        ...
        <table class="w-full">
          ...
          <tbody class="divide-y divide-gray-100">
            ...
            >
              <td class="px-6 py-4">
                <div class="flex items-center gap-3">
                  <div v-if="supervisor.avatar_url" class="w-10 h-10 rounded-full overflow-hidden">
                    <img
                  ...
                  >
                    {{ getInitials(supervisor.supervisor_name) }}
                  </div>
                  <div>
              ...
              <td class="px-6 py-4 text-gray-600">
                {{ supervisor.company || 'N/A' }}
              </td>

              <td class="px-6 py-4 text-center">
                <button
                  @click="openViewModal(supervisor)"
            ...
            <tr v-if="supervisors.length === 0">
              <td colspan="4" class="px-6 py-16">
                <div class="flex flex-col items-center justify-center text-gray-400">
                  ...
                  <p class="text-lg font-semibold text-gray-500">No supervisors found</p>
      ...
      >
        <div class="text-sm text-gray-600 font-medium">
          ...
          Total: <span class="font-bold text-gray-800">{{ pagination.total }}</span> supervisors
        </div>
...
const pagination = computed(() => supervisorStore.pagination);
...
const openViewModal = (supervisor) => {
...
const fetchData = async (page = 1) => {
  await supervisorStore.fetchSupervisors({ page, search: searchQuery.value.trim() });
};
